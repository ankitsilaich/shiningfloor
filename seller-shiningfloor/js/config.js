...
.factory('LoginService', ['$http', '$location', '$rootScope', function($http,$location, $rootScope){
  return {
    login: function(user, scope){
      ...
      var $promise = $http.post('../main_site/api/slim.php/auth/process/seller', user);  // send data to server to user.php
...
//          alert(responseData['message']);
    ...
    isLoggedIn: function(){
     var $checkSessionServer = $http.get('../main_site/api/slim.php/auth/process/seller');
